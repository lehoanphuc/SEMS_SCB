...
<div id="divToolbar">
    <div id="pnbutton" runat="server">
        <asp:Button ID="btnApproved" runat="server" CssClass="btn btn-primary" Text="<%$ Resources:labels, stsApprApprove %>" OnClick="btnApprove_Click" />
        <asp:Button ID="btnDoManual" runat="server" CssClass="btn btn-warning" Text="<%$ Resources:labels, DoManual %>" OnClick="btnManual_Click" />
        <asp:Button ID="btnReject" runat="server" CssClass="btn btn-warning" Text="<%$ Resources:labels, conreject %>" OnClick="btnReject_Click" />
