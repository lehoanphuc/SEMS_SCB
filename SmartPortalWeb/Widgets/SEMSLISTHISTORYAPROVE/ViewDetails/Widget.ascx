            ...
            <div class="panel">
                ...
                <div class="panel-container">
                    ...
                    <div class="panel-content div-btn rounded-bottom border-faded border-left-0 border-right-0 border-bottom-0 text-muted">
                        ...
                        <asp:Button ID="btnRollBack" CssClass="btn btn-primary" runat="server" Visible="false" Text="<%$ Resources:labels, rollback %>" OnClientClick="Loading();" OnClick="btnRollBack_Click" />
