﻿<%@ Control Language="C#" AutoEventWireup="true" CodeFile="widget.ascx.cs" Inherits="Widgets_SEMSLISTHISTORYAPROVE_Action_Reject_widget" %>
        ...
        <div class="col-sm-12 col-xs-12">
            <div class="panel">
                ...
                <div class="panel-container">
                    ...
                    <div class="row" visible="true" runat="server" id="divReject">
                        <div class="col-sm-12">
                            <div class="panel">
                                <div class="panel-hdr">
                                    <h2>Reject Reason </h2>
