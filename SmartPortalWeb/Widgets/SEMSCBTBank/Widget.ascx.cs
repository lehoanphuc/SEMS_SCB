...
protected void Page_Load(object sender, EventArgs e)
    ...
    private void loadCountry()
    {
        try
        {
            ...
            dtCountry = new SmartPortal.SEMS.Country().SearchCBTCountryByCondition("", "", "", 0, 0, ref IPCERRORCODE, ref IPCERRORDESC);
            if (IPCERRORCODE == "0")
            {
                ...
                ddlCountry.DataBind();
                ddlCountry.Items.Insert(0, new ListItem("ALL", "ALL"));
            }
        }
        catch (Exception ex)
        {
    ...
    protected void gvBankList_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            CheckBox cbxSelect;
            Label  lblBankName, lblCurrency, lblAddress, lblNostro, lblCountry;
