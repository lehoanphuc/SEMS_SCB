            ...
            <div class="blankpage-form-field">
                ...
                <div class="card p-4 border-top-left-radius-0 border-top-right-radius-0">
                    ...
                    <asp:LinkButton ID="lbForgotPassword" OnClick="lbForgotPassword_OnClick" Text='<%$ Resources:labels, quenmatkhau %>' runat="server"></asp:LinkButton>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
                        ...
                        <a href="<%= SmartPortal.Common.Encrypt.EncryptURL(SmartPortal.Common.Utilities.Utility.LinkMultiLang(true)+"l=vi-VN") %> "><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/21/Flag_of_Vietnam.svg/1280px-Flag_of_Vietnam.svg.png" style="width: 30px; height: 20px" /></a>
