...
namespace SmartPortal.SEMS
{
    public class Contract
    {
        ...
        #endregion
        #region InsertCIF Company
        public DataSet InsertCIFCompany(DataTable dtWorkflow, ref string errorCode, ref string errorDesc)
        {
            try
            {
                Hashtable hasInput = new Hashtable();
                Hashtable hasOutput = new Hashtable();
                hasInput.Add(SmartPortal.Constant.IPC.IPCTRANCODE, "EBACMAWINSERTCIFCOMPANY");
                ...
                AddKeyValue(ref hasInput, "EBA_CM_AW_Insert_CIF", "INSERTCIFCOMPANY", dtWorkflow);
