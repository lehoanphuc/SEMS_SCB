...
namespace SmartPortal.SEMS
{
    public class Fee
    {
        ...
        #endregion
        #region Insert Fee
        public DataSet InsertFee(string feeid, string tranCode, string feename, string feetype, string fixamount, bool isladder, bool isregionfee, string chargelater, string ccyid, string usercreated, string datecreated, string branchid, bool isbiller, DataTable tableFeeDetail, DataTable tablfeeTransfer, ref string errorCode, ref string errorDesc)
        {
            try
            {
                //Show hastable result from IPC
                ...
                tableFee.Columns.Add(coltrancode);
        ...
        #region search contract Fee2
        public DataSet SearchContractFee2(string contractno,string trancode, string feeid, string ccyid, string fullname, string status, string branchid, string feetype, int recPerPage, int recIndex, ref string errorCode, ref string errorDesc)
        {
            try
            {
                //Show hastable result from IPC
