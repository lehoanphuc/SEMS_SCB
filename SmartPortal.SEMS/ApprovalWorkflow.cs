...
namespace SmartPortal.SEMS
{
    public class ApprovalWorkflow
    {
        ...
        public DataSet WorkflowInsertAllBankStaff(DataTable dtWorkflow, ref string errorCode, ref string errorDesc)
        {
            try
            {
                //Show hastable result from IPC
                ...
                Hashtable hasOutput = new Hashtable();
                //add key into input
                hasInput.Add(SmartPortal.Constant.IPC.IPCTRANCODE, "EBACMAWINSERTALLBANKSTAFF");
                hasInput.Add(SmartPortal.Constant.IPC.SOURCEID, SmartPortal.Constant.IPC.SOURCEIDVALUE);
                //hasInput.Add(SmartPortal.Constant.IPC.ACTION, Action);
                AddKeyValue(ref hasInput, "EBA_CM_AW_Insert_BANKSTAFF", "INSERTWORKFLOWBANKSTAFF", dtWorkflow);
                hasOutput = SmartPortal.RemotingServices.AT.DBTRAN().ProcessTransHAS(hasInput);
                return CheckOutput(hasOutput, ref errorCode, ref errorDesc);
            }
            catch (Exception ex)
        ...
        public DataSet WorkflowDeleteAllBankStaff(DataTable dtWorkflow, ref string errorCode, ref string errorDesc)
        {
            try
            {
                //Show hastable result from IPC
                ...
                Hashtable hasOutput = new Hashtable();
                //add key into input
                hasInput.Add(SmartPortal.Constant.IPC.IPCTRANCODE, "EBACMAWDELETEBANKSTAFF");
                hasInput.Add(SmartPortal.Constant.IPC.SOURCEID, SmartPortal.Constant.IPC.SOURCEIDVALUE);
                //hasInput.Add(SmartPortal.Constant.IPC.ACTION, Action);
                AddKeyValue(ref hasInput, "EBA_CM_AW_Delete_BANKSTAFF", "DELETEWORKFLOWBANKSTAFF", dtWorkflow);
                //AddKeyValue(ref hasInput, "EBA_CM_AW_Insert_BANKSTAFF", "INSERTWORKFLOWBANKSTAFF", dtWorkflow);
                hasOutput = SmartPortal.RemotingServices.AT.DBTRAN().ProcessTransHAS(hasInput);
                return CheckOutput(hasOutput, ref errorCode, ref errorDesc);
            }
