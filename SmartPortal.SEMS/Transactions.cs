...
namespace SmartPortal.SEMS
{
    public class Transactions
    {
        ...
        //Reject or DoManual
        public DataSet DoActionStopTransaction(string IPCTRANSID, string userID, string Action, ref string errorCode, ref string errorDesc)
        {
            try
            {
                //Show hastable result from IPC
                ...
                hasInput.Add(SmartPortal.Constant.IPC.USERID, userID);
                hasInput.Add(SmartPortal.Constant.IPC.ACTION, Action);
        ...
        //NHANPT
        public int UpdateWorkFlowBankStaff(string IPCTRANSID, string APPROVALBY, string CREATEDATED, string ACTION)
        {
            try
            {
                int strErr = 0;
                ...
                SqlParameter p2 = new SqlParameter();
                p2.ParameterName = "@APPROVALBY";
                p2.Value = APPROVALBY;
                p2.SqlDbType = SqlDbType.NVarChar;


                SqlParameter p3 = new SqlParameter();
                p3.ParameterName = "@CREATEDATED";
                p3.Value = CREATEDATED;
                p3.SqlDbType = SqlDbType.NVarChar;


                SqlParameter p4 = new SqlParameter();
                p4.ParameterName = "@ACTION";
                p4.Value = ACTION;
                ...
                strErr = DataAccess.Execute("EBA_UPDATE_WORKFLOWBANKSTAFF", p1, p2, p3, p4);
        ...
        public DataSet LoadGroupName(ref string errorCode, ref string errorDesc)
        {
            try
            {
                //Show hastable result from IPC
                ...
                //add key into input
                hasInput.Add(SmartPortal.Constant.IPC.IPCTRANCODE, "SEMSLOADGROUPUSER");
                hasInput.Add(SmartPortal.Constant.IPC.SOURCEID, SmartPortal.Constant.IPC.SOURCEIDVALUE);
                hasInput.Add(SmartPortal.Constant.IPC.SOURCETRANREF, SmartPortal.Constant.IPC.SOURCETRANREFVALUE);
                hasInput.Add(SmartPortal.Constant.IPC.TRANDESC, "Load information for app");
                hasInput.Add(SmartPortal.Constant.IPC.REVERSAL, "N");
        ...
        //nhanpt
        public DataSet ViewListWaitApprovedBankStaff(string tranID, string tranCode, string from, string to, string status, string account, string apprsts, string custcodecore, string custname, string contractno, string checkno, string creditAcct, string userApproved, string licenseid, string isschedule, int recPerPage, int recIndex, ref string errorCode, ref string errorDesc)
        {
            try
            {
                Hashtable hasInput = new Hashtable();
                Hashtable hasOutput = new Hashtable();
                hasInput.Add(SmartPortal.Constant.IPC.IPCTRANCODE, "SEMSVIEWLISTAPRPVALSTAFF");
                hasInput.Add(SmartPortal.Constant.IPC.SOURCEID, SmartPortal.Constant.IPC.SOURCEIDVALUE);
                hasInput.Add(SmartPortal.Constant.IPC.TRANID, tranID);
                hasInput.Add(SmartPortal.Constant.IPC.TRANCODE, tranCode);
                hasInput.Add(SmartPortal.Constant.IPC.FROM, from);
        ...
        public DataTable GetWorkflowBankStaffByTrans(string transactionId)
        {
            DataTable iRead;
            SqlParameter p1 = new SqlParameter();
            p1.ParameterName = "@TRANSID";
            p1.Value = transactionId;
            p1.SqlDbType = SqlDbType.Text;
            iRead = DataAccess.GetFromDataTable("SEMS_LOADWORKFLOWBANKSTAFFBYTRANS", p1);
            return iRead;
        }
        ...
        #region Get list of appvoval transaction for bank staff
        public DataSet GetListAppTransForBankStaff(string tranID, string tranCode, string from, string to, string status, string account, string apprsts, string custcodecore, string custname, string contractno, string checkno, string creditAcct, string userApproved, string licenseid, string isschedule, int recPerPage, int recIndex, ref string errorCode, ref string errorDesc)
        {
            try
            {
                Hashtable hasInput = new Hashtable();
                Hashtable hasOutput = new Hashtable();
                hasInput.Add(SmartPortal.Constant.IPC.IPCTRANCODE, "SEMSLISTAPPTRAN");
                hasInput.Add(SmartPortal.Constant.IPC.SOURCEID, SmartPortal.Constant.IPC.SOURCEIDVALUE);
                hasInput.Add(SmartPortal.Constant.IPC.TRANID, tranID);
                hasInput.Add(SmartPortal.Constant.IPC.TRANCODE, tranCode);
                hasInput.Add(SmartPortal.Constant.IPC.FROM, from);
        ...
        public DataSet ViewListWaitApproved(string tranID, string tranCode, string from, string to, string status, string account, string apprsts, string custcodecore, string custname, string contractno, string checkno, string creditAcct, string userApproved, string licenseid, string isschedule, int recPerPage, int recIndex, ref string errorCode, ref string errorDesc)
        {
            try
            {
                Hashtable hasInput = new Hashtable();
