...
namespace SmartPortal.IB
{
    public class Transactions
    {
        ...
        public DataSet BankStaffApp(string IPCTRANSID, string authenType, string authenCode, string userID, ref string errorCode, ref string errorDesc)
        {
            try
            {
                //Show hastable result from IPC
                ...
                //add key into input
                hasInput.Add(SmartPortal.Constant.IPC.IPCTRANCODE, "IB0000444");
                hasInput.Add(SmartPortal.Constant.IPC.SOURCEID, SmartPortal.Constant.IPC.SOURCEIBVALUE);
                hasInput.Add(SmartPortal.Constant.IPC.SOURCETRANREF, SmartPortal.Constant.IPC.SOURCETRANREFVALUE);
        ...
        public DataSet BankStaffDestroyTran(string IPCTRANSID, string desc, string name, ref string errorCode, ref string errorDesc)
        {
            try
            {
                //Show hastable result from IPC
                ...
                //add key into input
                hasInput.Add(SmartPortal.Constant.IPC.IPCTRANCODE, "IB0000411");
                hasInput.Add(SmartPortal.Constant.IPC.SOURCEID, SmartPortal.Constant.IPC.SEMS);
                hasInput.Add(SmartPortal.Constant.IPC.TRANDESC, "Reject transaction");
                hasInput.Add(SmartPortal.Constant.IPC.REVERSAL, "N");
